    ...
    <body class="h-full">
        <div class="grid min-h-full grid-cols-1 grid-rows-[1fr,auto,1fr] bg-white lg:grid-cols-[max(50%,36rem),1fr]">
            ...
            <main class="mx-auto w-full max-w-7xl px-6 py-24 sm:py-32 lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:px-8">
              <div class="max-w-lg">
                <p class="text-base font-semibold leading-8 text-pink-700">@yield('code')</p>
                <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Page not found</h1>
                <p class="mt-6 text-base leading-7 text-gray-600"> @yield('message') </p>
                <div class="mt-10">
                  <a href=" {{ url()->previous()}} " class="text-sm font-semibold leading-7 text-yellow-600"><span aria-hidden="true">&larr;</span> Go back</a>
                </div>
              </div>
            </main>
