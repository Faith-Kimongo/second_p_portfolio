          ...
          <div class="relative bg-white border-b">
            <div class="mx-auto flex max-w-7xl items-center justify-between px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
              ...
              <div class="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
                <a href="{{route('job.index')}}" class="whitespace-nowrap text-base font-medium text-gray-600 hover:text-gray-900">Find jobs</a>
                ...
                <a href=" {{route('myhustle.index')}} " class="ml-4 whitespace-nowrap text-base font-medium text-gray-600 hover:text-gray-900">MyHustle</a>
              </div>
            </div>
